...
| Area | What it covers |
|---|---|
| Transport | Frames, bytes, rejections, registered peers, active connections, send backpressure. TCP, UDS, and QUIC also give egress queue wait, frames written, and write duration. |
