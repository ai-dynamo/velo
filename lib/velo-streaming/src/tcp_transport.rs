...
//! [`crate::velo_transport::VeloFrameTransport`] without the per-stream
...
mod tests {
    ...
    async fn unknown_token_is_rejected_and_does_not_disrupt_others() {
        ...
        let payload = rmp_serde::to_vec(&crate::frame::StreamFrame::<u32>::Item(7)).unwrap();
    ...
    async fn concurrent_binds_all_succeed_through_one_listener() {
        ...
        for i in 0u64..32 {
            ...
            handles.push(tokio::spawn(async move {
                ...
                let payload =
                    rmp_serde::to_vec(&crate::frame::StreamFrame::<u64>::Item(i)).unwrap();
