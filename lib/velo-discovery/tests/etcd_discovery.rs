...
use velo_discovery::etcd::EtcdServiceDiscoveryBuilder;
use velo_discovery::{ServiceDiscovery, ServiceEvent, ServiceRegistrationGuard};

async fn make_discovery() -> velo_discovery::etcd::EtcdServiceDiscovery {
