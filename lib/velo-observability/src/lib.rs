...
impl DispatchFailure {
    ...
    pub fn as_stage_reason(self) -> (&'static str, &'static str) {
        match self {
...
impl ClientResolution {
    ...
    pub fn as_path_outcome(self) -> (&'static str, &'static str) {
        match self {
...
impl TransportMetricsHandle {
    ...
    pub fn record_frame(&self, direction: Direction, message_type: &str, bytes: usize) {
        let direction_idx = direction.index();
...
#[derive(Clone)]
pub struct HandlerMetricsHandle {
    in_flight: Gauge,
...
#[derive(Clone)]
pub struct StreamingTransportMetricsHandle {
...
impl VeloMetrics {
    ...
    pub fn bind_handler(&self, handler: &str) -> Option<HandlerMetricsHandle> {
    ...
    pub fn bind_streaming_transport(
        &self,
    ...
    pub fn record_dispatch_failure(&self, failure: DispatchFailure) {
    ...
    pub fn record_client_resolution(&self, resolution: ClientResolution) {
    ...
    pub fn set_streaming_active_anchors(&self, count: usize) {
        self.streaming_active_anchors.set(count as f64);
    }

    /// Record a streaming backpressure event.
    pub fn record_streaming_backpressure(&self, transport_scheme: &str) {
    ...
    pub fn record_rendezvous_operation(
        &self,
    ...
    pub fn record_rendezvous_bytes(&self, operation: RendezvousOp, bytes: usize) {
    ...
    pub fn set_rendezvous_active_slots(&self, count: usize) {
