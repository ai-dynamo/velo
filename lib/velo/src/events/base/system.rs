    ...
    pub(crate) fn new_event_with_backend(
        ...
        loop {
            ...
            match entry.begin_generation() {
                ...
                Err(crate::events::slot::entry::EventEntryError::GenerationOverflow { key }) => {
                    trace!(
                        ?key,
