...
//! behind [`AckHandle`]. The typed [`WorkItem`](crate::queue::WorkItem) wrapper owns
...
///
/// Produced by [`ReceiverBackend`](crate::queue::ReceiverBackend) implementations
/// under [`AckPolicy::Manual`](crate::queue::AckPolicy::Manual) and consumed by the
/// methods on [`WorkItem`](crate::queue::WorkItem).
///
