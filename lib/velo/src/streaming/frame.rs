...
/// Errors surfaced to [`StreamAnchor`](crate::streaming::anchor::StreamAnchor) consumers.
///
...
/// Errors surfaced to [`crate::streaming::sender::StreamSender`] callers when a send operation fails.
#[derive(Debug, thiserror::Error)]
#[non_exhaustive]
pub enum SendError {
