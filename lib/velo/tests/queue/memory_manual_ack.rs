...
use velo::queue::backends::memory::InMemoryBackend;
use velo::queue::{
...
async fn setup(
    ...
    InMemoryBackend,
    velo::queue::WorkQueueSender<Job>,
    velo::queue::WorkQueueReceiver<Job>,
) {
...
async fn batch_partial_ack_redelivers_nacked() {
    ...
    let opts = velo::queue::NextOptions::new()
        .batch_size(5)
    ...
    let opts2 = velo::queue::NextOptions::new()
        .batch_size(5)
        .timeout(Duration::from_millis(500));
